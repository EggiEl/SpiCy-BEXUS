...
#define CLIENTIP IPAddress(169, 254, 1, 100)  //ip of this uC, leve blank for auto generation IPAddress(169, 168, 1, 100)
...
void setup_TCP_Client() {
  ...
  Ethernet.begin(mac);  //mac, CLIENTIP, DNS, GATEWAY, SUBNET
  Ethernet.setLocalIP(CLIENTIP);
