...
def equations(vars, x1, y1, x2, y2, x3, y3,x4,y4):
    K, T1, T2, x0 = vars
...
# Initial guesses for K, T1, T2, x0
initial_guess = [35.4162695640935, 1715, 1155, 1000]
...
solution = fsolve(equations, initial_guess, args=(x1, y1, x2, y2, x3, y3, x4, y4))
K, T1, T2, x0 = solution
